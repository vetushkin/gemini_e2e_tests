...
describe('Transfer page tests', function(){
	...
	it('Verify that you can make a transfer from Sportsbook to Eur Casino', function(){
		page.visit('mobile/account/transfer');
		page.transferFrom('sportsbook');
	...
	it('Verify that you can make a transfer from Eur Casino to Sportsbook', function(){
		page.visit('mobile/account/transfer');
