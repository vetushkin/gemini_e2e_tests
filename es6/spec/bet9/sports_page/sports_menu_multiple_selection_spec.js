...
describe('Sports menu multiple events select in one Sport category', function(){
	...
	it('Verify that you can select 2 games from Basquete sport', function(){
		page.sportsMenu().clickLink('Basquete');
	...
	it('Verify that you can select 3 games from Futebol sport', function(){
