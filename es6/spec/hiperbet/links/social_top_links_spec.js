...
describe('Social links test', function(){
	...
	it('Verify that VIP link opens the correct page', function(){
		page.social().clickLink('vip');
		expect(page.currentUrl()).toContain('vip');
		expect(page.noError()).toBe(true);
	});
	...
	it('Verify that Kurallar ve Şartlar link opens the correct page', function(){
		page.social().clickLink('kurallar-ve-sartlar');
		expect(page.currentUrl()).toContain('kurallar-ve-sartlar');
		expect(page.noError()).toBe(true);
	});
	...
	it('Verify that S.S.S link opens the correct page', function(){
		page.social().clickLink('sss');
		expect(page.currentUrl()).toContain('sss');
		expect(page.noError()).toBe(true);
	});
