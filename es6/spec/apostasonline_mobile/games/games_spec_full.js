...
describe('Casino page tests', function(){
	...
	for (let i = 0; i < 35; i++) {
		it('Verify that you can start the casino game #'+ (i+1) + ' in free mode', function(){
			page.visit('mobile/casino');
			page.clickGame(i);
			page.startGame('free');
			expect(page.isGameStarted()).toBe(true);
	...
	for (let i = 0; i < 35; i++) {
		it('Verify that you can start the casino game #'+ (i+1) + ' in real mode', function(){
			page.visit('mobile/casino');
			page.clickGame(i);
			page.startGame('real');
			expect(page.isGameStarted()).toBe(true);
