...
describe('Account transfer page verification', function(){
	...
	it('Verify that from Bahis Hesabınız to CTXMGames shows correct currency', function(){
		page.selectFrom('sportsbook');
	...
	it('Verify that from CTXMGames to Bahis Hesabınız shows correct currency', function(){
