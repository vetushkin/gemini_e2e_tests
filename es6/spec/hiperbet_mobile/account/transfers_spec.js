...
describe('Transfer page tests', function(){
	...
	it('Verify that you can make a transfer from Sportsbook to Casino EUR', function(){
		page.visit('mobile/account/transfer');
		page.transferFrom('sportsbook');
	...
	it('Verify that you can make a transfer from Casino EUR to Sportsbook', function(){
		page.visit('mobile/account/transfer');
