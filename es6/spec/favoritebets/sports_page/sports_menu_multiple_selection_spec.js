...
describe('Sports menu multiple events select in one Sport category', function(){
	...
	it('Verify that you can select 2 games from Basketball sport', function(){
		page.sportsMenu().clickLink('Basketball');
	...
	it('Verify that you can select 3 games from Fotball sport', function(){
