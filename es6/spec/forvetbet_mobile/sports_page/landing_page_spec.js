...
describe('Landing page links test', function(){
	...
	it('Verify that Sportsbook link opens the correct page', function(){
		page.clickLink('sportsbook');
		expect(page.brokenImagesCount()).toBe(0);
		expect(page.noError()).toBe(true);
		expect(page.currentUrl()).toContain('sportsbook');
	});

	it('Verify that Casino link opens the correct page', function(){
		page.clickLink('casino');
		expect(page.brokenImagesCount()).toBe(0);
		expect(page.noError()).toBe(true);
		expect(page.currentUrl()).toContain('casino');
	});

	it('Verify that Live Casino link opens the correct page', function(){
		page.clickLink('live_casino');
		expect(page.brokenImagesCount()).toBe(0);
		expect(page.noError()).toBe(true);
